                  ...
                  <div class="single-post row">
                      <div class="col-lg-12">
                          <div class="feature-img">
                              <img class="img-fluid" src="img/vote_detail/building.png" alt="">
                          </div>
                      </div>
                  ...
                  <div class="blog_right_sidebar">
                      <aside class="single_sidebar_widget author_widget">
                          ...
                          <p>상권에 관한 내용 설명
                              ...
                              inline태그 - a, em, img, strong, input, label, select, textarea ,span
                              <br>
                              <br>
                          </p>   
                          <hr>
