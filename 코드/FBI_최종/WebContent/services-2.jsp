    ...
    <div class="hero-banner__content text-center">
      ...
      <nav aria-label="breadcrumb" class="banner-breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">후원 진행중</li>
        </ol>
      </nav>
    </div>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="section-title">
            <h2 class="title">For Better Information</h2>
          </div>
          <div class="about-content">
            <p>저희 KB FBI는 막연하고 애매한 정보들로 회원 여러분을 혼란스럽게 하지 않겠습니다.

상권분석표, 매물정보, 창업자 정보 등 다양한 정보들을 적극 제공함으로써 보다 확신을 가지고 주체적으로 펀딩에 참여하실 수 있도록 최선을 다하겠습니다. </p>
            <a href="#" class="primary-button">더보기</a>
          </div>
        </div>
        <!-- /about content -->
  ...
  <div id="causes" class="section">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <!-- causes -->
        <div class="col-md-4">
        <form name ="form1" method="get" action="blog-details_fund.jsp">
        ...
        <!-- causes -->
        <div class="col-md-4">
        <form name ="form2" method="get" action="blog-details_fund.jsp">
        ...
        <!-- causes -->
        <div class="col-md-4">
        <form name ="form3" method="get" action="blog-details_fund.jsp">
  ...
  <div id="testimonial" class="section">
    <!-- background section -->
    <div class="section-bg" style="background-image: url(./img/index/background-2.jpg);" data-stellar-background-ratio="0.5"></div>
    <!-- /background section -->
