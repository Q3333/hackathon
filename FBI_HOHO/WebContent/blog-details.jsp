												...
												<div class="media post_item">
													<select>
														...
														<optgroup label="휴게음식점(카페,제과)">
															...
															<option value="KIDSCAFE">키즈카페</option>
															<option value="PETCAFE">펫카페</option>
															<option value="STUDYCAFE">스터디카페</option>
															
														</optgroup>
														<optgroup label="일반음식점">
															<option value="KRFOOD">한식</option>
															<option value="양식">양식</option>
															<option value="CHIFOOD">중식</option>
															<option value="JAPFOOD">일식</option>
