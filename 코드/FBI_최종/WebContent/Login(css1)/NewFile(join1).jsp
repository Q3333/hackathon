...
<div class='form-input'>
	<label>창업 날짜</label>
	<input type='date' name='foundDate' placeholder="YY/MM/DD">
</div><!-- form-input -->
<div class="cost-us">
<label>창업 예상 비용</label>
<input type='range' name='foundMoney' min=1 max=500000 >(만원)<br>
</div>
<div class="form-radio-group">
<label>지금 창업상담신청 하시겠습니까?</label>
<div class='form-radio-item'>
<input type='radio' name='adviceYN' value='Y' id="yes">
 <label for="yes">상담신청하기</label>
 <span class='check'></span>
</div>
<div class='form-radio-item'>
<input type='radio' name='adviceYN' value='N' id="no">
 <label for="no">나중에 하기</label>
<span class='check'> </span>
</div>
</div>
