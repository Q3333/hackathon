  ...
  <section class="header-top d-none d-sm-block">
    <div class="container">
      <div class="d-sm-flex justify-content-between">
        ...
        <a href="Login(css1)/NewFile(select).jsp"><font color="gray"><strong>회원가입</strong></font></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="img/banner/main_banner2.png" width="1648" height="300" alt="">
          <div class="carousel-caption">
            <h2><strong>당신의 상가에</strong></h2>
            <h3><strong>투표하세요!</strong></h3>
            <a href="services-1.jsp"><strong>투표하기</strong></a>
        </div>
 
</div>
        <div class="item">
          <img src="img/banner/main_banner1.png" width="1648" height="300" alt="">
          <div class="carousel-caption">
            <h2><strong><font color="Orange">매칭된</font> 크라우드펀드에</strong></h2>
            <h3><strong>투자해보세요!</strong></h3>
            <a href="services-2.jsp"><strong>펀드 하러가기</strong></a>
        </div>
        </div>
       </div>
  ...
  <section class="section-margin">
   ...
   <div id="now">
      ...
      <div class="section-title text-center">
        ...
        <p class="sub-title"><h2>*실시간  투표현황</h2></p>
      </div>
      </div>
  <!-- section title -->
  ...
  <form name ="form1" method="get" action="blog-details_vote.jsp">
     <div class="col-md-4">
       <div class="causes">
         ...
         <input type="hidden" name="BDID" value=<%=map.get(4).get("BDID").toString() %>  />
           <a onclick="onClick(1)">
